...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        * { color:#ffffff; }
        ...
        # Lock Button
        self.Lock = self.create_button(self.RightSide, 20, 20, "     Unlock", "lock-open-alt.png", self.toggle_lock)

        # Bluetooth Button
        self.Bluetooth = self.create_button(self.RightSide, 20, 120, "     Bluetooth", "bluetooth-alt.png")

        # Navigation Button
        self.Navigation = self.create_button(self.RightSide, 20, 220, "     Navigation", "map-marker.png", self.show_map)

        # Sign Detection Button
        self.SignDetection = self.create_button(self.RightSide, 20, 320, "     Sign Detection", "road-sign.png")
